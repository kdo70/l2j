...
public class DropData {
     ...
     */
    public IntIntHolder calculateDrop(double ratio, boolean raid, Player player) {
        int min = (int) Math.ceil(_minDrop * RateHelper.getDropCountRate(this, raid, player));
        int max = (int) Math.ceil(_maxDrop * RateHelper.getDropCountRate(this, raid, player));
        ...
        if (ratio <= 1) {
            ...
            count = Rnd.get(min * multiplier, max * multiplier);
