...
import net.sf.l2j.gameserver.expander.newbiehelper.conditions.VisibleBuffCondition;
...
public class GetListAction extends Action {
    ...
    protected final String _listFile = "data/html/script/feature/NewbieHelper/buff_list.htm";
    protected final String _tableListFile = "data/html/script/feature/NewbieHelper/buff_table_list.htm";
    ...
    public String execute(Player player, Npc npc) {
        ...
        for (int index = 0; index < _buffList.size(); index++) {
            ...
            try {
                BufferedReader reader = new BufferedReader(new FileReader(_tableListFile));
