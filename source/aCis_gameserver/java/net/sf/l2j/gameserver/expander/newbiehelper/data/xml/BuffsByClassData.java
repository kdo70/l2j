package net.sf.l2j.gameserver.expander.newbiehelper.data.xml;
...
public class BuffsByClassData implements IXmlReader {
    ...
    @Override
    public void load() {
        parseFile("./data/xml/expander/NewbieHelper/Buffs/classes.xml");
        LOGGER.info("Loaded {} classes newbie buffs.", _buffs.size());
    }
