...
public class Party extends AbstractGroup {
     ...
     */
    public void distributeXpAndSp(long xpReward, int spReward, List<Player> rewardedMembers, int topLvl, Map<Creature, RewardInfo> rewards, Monster monster) {
        final List<Player> validMembers = new ArrayList<>();
        ...
        for (Player member : rewardedMembers) {
            ...
            if (validMembers.contains(member)) {
                ...
                member.addExpAndSp(xp, sp, rewards, monster);
            } else
                member.addExpAndSp(0, 0, monster);
        }
    }
