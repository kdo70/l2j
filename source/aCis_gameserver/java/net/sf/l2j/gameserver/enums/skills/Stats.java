...
public enum Stats {
    ...
    MONSTER_MUL_PHYS_DEF("monsterMulPhysDef", true),
    MONSTER_MUL_ADENA_CHANCE("monsterMulAdenaChance", true),
    MONSTER_MUL_GOLD_CHANCE("monsterMulGoldChance", true),
    MONSTER_MUL_ITEMS_CHANCE("monsterMulItemsChance", true),
    MONSTER_MUL_EQUIP_CHANCE("monsterMulEquipChance", true),
    MONSTER_MUL_ADENA_COUNT("monsterMulAdenaCount", true),
    MONSTER_MUL_GOLD_COUNT("monsterMulGoldCount", true),
    MONSTER_MUL_ITEMS_COUNT("monsterMulItemsCount", true),
    MONSTER_MUL_EQUIP_COUNT("monsterMulEquipCount", true),
    MONSTER_MUL_EXP("monsterMulExp", true),
    MONSTER_MUL_SP("monsterMulSp", true);
