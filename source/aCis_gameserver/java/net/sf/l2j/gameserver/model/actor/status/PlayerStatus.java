...
public class PlayerStatus extends PlayableStatus<Player> {
    ...
    public boolean addExpAndSp(long addToExp, int addToSp, Creature creature) {
        if (!super.addExpAndSp(addToExp, addToSp))
            return false;
    ...
    public boolean addExpAndSp(long addToExp, int addToSp, Map<Creature, RewardInfo> rewards, Creature creature) {
        addToExp = RateHelper.calculateExp(addToExp, _actor, creature);
        addToSp = RateHelper.calculateSp(addToSp, _actor, creature);
        ...
        return addExpAndSp(addToExp, addToSp, creature);
    }
