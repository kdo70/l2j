...
public class GetInfoAction extends Action {
    protected final String _itemFile = "data/html/script/feature/NewbieHelper/buff_list_item.htm";
    protected final String _paginationFile = "data/html/script/feature/NewbieHelper/buff_list_pagination.htm";
    ...
    private String getTemplateItem(BuffHolder buffHolder) {
        try {
            BufferedReader reader = new BufferedReader(new FileReader(_itemFile));
    ...
    private String getTemplatePagination(int page, boolean hasMore) {
        try {
            BufferedReader reader = new BufferedReader(new FileReader(_paginationFile));
