...
import net.sf.l2j.gameserver.expander.config.actions.LoadSkillDurationListAction;
...
public final class Config {
    ...
    private static final LoadSkillDurationListAction _loadSkillDurationListAction = new LoadSkillDurationListAction();
    ...
    private static final void loadPlayers() {
        ...
        KARMA_NONDROPPABLE_PET_ITEMS = players.getProperty("ListOfPetItems", new int[]{2375, 3500, 3501, 3502, 4422, 4423, 4424, 4425, 6648, 6649, 6650});
        KARMA_NONDROPPABLE_ITEMS = players.getProperty("ListOfNonDroppableItemsForPK", new int[]{1147, 425, 1146, 461, 10, 2368, 7, 6, 2370, 2369});
        ...
        SKILL_DURATION_LIST = _loadSkillDurationListAction.execute(players);
    }
    ...
    public static final void loadGameServer() {
        LOGGER.info("Loading game server configuration files.");
        loadClans();
        loadEvents();
        loadGeoengine();
        loadHexID();
